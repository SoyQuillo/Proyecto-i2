    ...
    <header className="w-full bg-gradient-to-r from-white via-sky-50 to-cyan-50 shadow-md border-b border-sky-100 fixed top-0 left-0 right-0 z-50 h-16">
      <div className="flex items-center justify-between px-6 py-3 h-full">
        <div className="flex items-center gap-3">
          <div className="bg-gradient-to-br from-sky-600 to-cyan-600 p-2 rounded-xl shadow-lg">
            <Activity size={24} className="text-white" />
          </div>
          <div className="flex flex-col leading-tight">
            <span className="font-bold text-base text-gray-900">HospitalIS Pro</span>
            <span className="text-xs font-medium text-sky-600">Portal del paciente</span>
          </div>
        </div>
        ...
        <div className="relative" ref={userMenuRef}>
          ...
          >
            <div className="bg-gradient-to-br from-sky-600 to-cyan-600 rounded-lg p-2 shadow-md">
              <User size={18} className="text-white" />
            </div>
            <div className="flex flex-col leading-tight text-left">
              <span className="text-sm font-bold text-gray-900 truncate max-w-[180px]">{nombre}</span>
              <span className="text-xs text-sky-600 font-medium">Paciente</span>
            </div>
          </button>
